...
s32 main()
{
	...
	WebviewData webview_data = INITIALIZE_ZERO;
	// webview_data.default_url = L"https://twitch.tv";
	WebviewRect webview_rect = { 400, 100, 400, 400 };
	create_webview2_environment(webview_data, window, webview_rect);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		{
			navigate_to_url(webview_data, L"https://novachrono.substack.com");
		}
