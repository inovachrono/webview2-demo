...
set includePaths=%includePaths% -I "%projectDir%\packages\Microsoft.Web.WebView2.1.0.1293.44\build\native\include" -I "%projectDir%\packages\Microsoft.Windows.ImplementationLibrary.1.0.220201.1\include"
set libPaths=-LIBPATH:"%projectDir%\lib"
set libPaths= %libPaths% -LIBPATH:"%projectDir%\packages\Microsoft.Web.WebView2.1.0.1293.44\build\native\x64"
set linkLibs=kernel32.lib user32.lib gdi32.lib shell32.lib opengl32.lib glfw3.lib WebView2Loader.dll.lib

set CommonCompilerFlags=-MD -nologo -Gm- -Od -Oi -W4 -wd4201 -wd4100 -FC -Fm -Z7 -D_CRT_SECURE_NO_WARNINGS -D_UNICODE -DUNICODE -DWIN32 -D_WINDOWS
...
cl %includePaths% %CommonCompilerFlags% -EHsc "%sourceCodePath%\main.cpp" /link %libPaths% %CommonLinkerFlags% %linkLibs%
popd